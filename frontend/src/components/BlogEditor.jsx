    ...
    <>
      <nav className="navbar">
        ...
        <div className="flex gap-4 ml-auto">
          <button className="btn-dark-two py-2 ">Publish</button>
        ...
        <section className="px-[5vw]">
            <div className=" mx-auto   max-w-[900px]  w-full ">
                ...
                <textarea 
                  ...
                  className=" text-4xl font-medium w-full h-20 resize-none  outline-none mt-10 leading-tight placeholder:opacity-40 bg-red-400 "
